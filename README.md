...
<br />
Что решает вышеперечисленное: &quot;кажется, функция называется...&quot;, &quot;как или где я могу найти ProcessEvent?&quot; и т.д. Если даже с такой помощью у вас ничего не получится, то я хз.<br />
<br />
-- <br />
<br />
